	...
	public String readresearchstatus() {
		...
		try {
			...
			while (rs.next()) {
				...
				output += "<tr><td><input input id='hidItemIDUpdate' name='hidItemIDUpdate' type='hidden' value='" + refID + "'>" +  researchID +"</td>";
			...
			/*	output += "<td><form method='post' action='researchstatus.jsp'>"
				...
				output += "<td><input name='btnUpdate' type='button' value='Update'class='btnUpdate btn btn-secondary'></td>" + "<td><input name='btnRemove'  type='button' value='Remove'  class='btnRemove btn btn-danger'  data-refid='" + refID + "'>  </td></tr>";
			}
			con.close();
